...
const (
	NullValue_enum_fullname = "olympus.fleet/ext/protocolbuffers/protobuf-go.NullValue"
...
const (
	...
	Struct_message_fullname protoreflect.FullName = "olympus.fleet/ext/protocolbuffers/protobuf-go.Struct"
)
...
const (
	...
	Struct_Fields_field_fullname protoreflect.FullName = "olympus.fleet/ext/protocolbuffers/protobuf-go.Struct.fields"
)
...
const (
	...
	Struct_FieldsEntry_message_fullname protoreflect.FullName = "olympus.fleet/ext/protocolbuffers/protobuf-go.Struct.FieldsEntry"
)
...
const (
	...
	Struct_FieldsEntry_Key_field_fullname   protoreflect.FullName = "olympus.fleet/ext/protocolbuffers/protobuf-go.Struct.FieldsEntry.key"
	Struct_FieldsEntry_Value_field_fullname protoreflect.FullName = "olympus.fleet/ext/protocolbuffers/protobuf-go.Struct.FieldsEntry.value"
)
...
const (
	...
	Value_message_fullname protoreflect.FullName = "olympus.fleet/ext/protocolbuffers/protobuf-go.Value"
)
...
const (
	...
	Value_NullValue_field_fullname   protoreflect.FullName = "olympus.fleet/ext/protocolbuffers/protobuf-go.Value.null_value"
	Value_NumberValue_field_fullname protoreflect.FullName = "olympus.fleet/ext/protocolbuffers/protobuf-go.Value.number_value"
	Value_StringValue_field_fullname protoreflect.FullName = "olympus.fleet/ext/protocolbuffers/protobuf-go.Value.string_value"
	Value_BoolValue_field_fullname   protoreflect.FullName = "olympus.fleet/ext/protocolbuffers/protobuf-go.Value.bool_value"
	Value_StructValue_field_fullname protoreflect.FullName = "olympus.fleet/ext/protocolbuffers/protobuf-go.Value.struct_value"
	Value_ListValue_field_fullname   protoreflect.FullName = "olympus.fleet/ext/protocolbuffers/protobuf-go.Value.list_value"
)
...
const (
	...
	Value_Kind_oneof_fullname protoreflect.FullName = "olympus.fleet/ext/protocolbuffers/protobuf-go.Value.kind"
)

// Names for google.protobuf.ListValue.
const (
	ListValue_message_name     protoreflect.Name     = "ListValue"
	ListValue_message_fullname protoreflect.FullName = "olympus.fleet/ext/protocolbuffers/protobuf-go.ListValue"
)
...
const (
	...
	ListValue_Values_field_fullname protoreflect.FullName = "olympus.fleet/ext/protocolbuffers/protobuf-go.ListValue.values"
)
